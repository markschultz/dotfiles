...
export PATH=~/bin:~/.xmonad/bin:~/.cabal/bin:~/android-sdk-linux/platform-tools:/usr/local/go/bin:/usr/local/cuda/bin:$HOME/git/rbenv/bin:/root/.gem/ruby/2.0.0/bin:$PATH

...
#my own aliases
alias wgetn='wget --content-disposition'
alias ee='cd /home/razor/EECS337/mxs802'
alias printm='lpr -p -U mark -o fitplot'  
alias print2='lpr -p -U mark -o fitplot -o number-up=2'
alias print4='lpr -p -U mark -o fitplot -o number-up=4'
